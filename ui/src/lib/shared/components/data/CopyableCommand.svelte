...
<button
	type="button"
	class="group flex w-full items-center gap-2 rounded bg-gray-900 px-2.5 py-1.5 text-left font-mono text-xs text-gray-300 transition-colors hover:bg-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800"
	onclick={copy}
	title="Click to copy"
>
