...
use crate::server::{
    ...
    host_port_overrides::r#impl::base::HostPortOverride, hosts::r#impl::base::Host,
...
pub struct StorageFactory {
    ...
    pub host_port_overrides: Arc<GenericPostgresStorage<HostPortOverride>>,
    ...
    pub custom_service_definitions: Arc<GenericPostgresStorage<CustomServiceDefinition>>,
    // Junction tables
...
impl StorageFactory {
    pub async fn new(database_url: &str, use_secure_session_cookies: bool) -> Result<Self> {
        ...
        Ok(Self {
            ...
            host_port_overrides: Arc::new(GenericPostgresStorage::new(pool.clone())),
            ...
            custom_service_definitions: Arc::new(GenericPostgresStorage::new(pool.clone())),
