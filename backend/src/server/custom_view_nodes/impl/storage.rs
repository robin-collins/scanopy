    ...
    fn to_params(&self) -> Result<(Vec<&'static str>, Vec<SqlValue>), anyhow::Error> {
        Ok((
            ...
            vec![
                ...
                SqlValue::OptionalString(self.base.font_family.clone()),
                SqlValue::OptionalI64(self.base.font_size),
                SqlValue::OptionalString(self.base.text_color.map(|c| c.to_string())),
                SqlValue::OptionalBool(self.base.font_bold),
                SqlValue::OptionalBool(self.base.font_italic),
                SqlValue::OptionalBool(self.base.font_underline),
                SqlValue::OptionalString(self.base.text_align.map(|align| align.to_string())),
                SqlValue::OptionalString(self.base.label.clone()),
                SqlValue::OptionalString(self.base.name.clone()),
                SqlValue::OptionalString(self.base.description.clone()),
                SqlValue::Bool(self.base.show_label),
                SqlValue::Bool(self.base.show_description),
    ...
    fn from_row(row: &PgRow) -> Result<Self, anyhow::Error> {
        Ok(CustomViewNode {
            ...
            base: CustomViewNodeBase {
                ...
                text_color: row
                    .get::<Option<String>, _>("text_color")
                    .and_then(|s| s.parse::<Color>().ok()),
                font_bold: row.get("font_bold"),
                font_italic: row.get("font_italic"),
                font_underline: row.get("font_underline"),
                text_align: row
                    .get::<Option<String>, _>("text_align")
                    .and_then(|align| align.parse().ok()),
                label: row.get("label"),
                name: row.get("name"),
                description: row.get("description"),
                show_label: row.get("show_label"),
                show_description: row.get("show_description"),
                style: row
