...
async fn test_host_crud(ctx: &TestContext) -> Result<(), String> {
    ...
    let update_request = UpdateHostRequest {
        ...
        os_detail: fetched.os_detail.clone(),
        manufacturer: fetched.manufacturer.clone(),
        model: fetched.model.clone(),
        category_id: fetched.category_id,
        topology_icon_image_id: fetched.topology_icon_image_id,
